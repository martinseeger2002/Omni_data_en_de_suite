...
with open("in.mp3", "rb") as file_to_string:
...
n = 255
data_list = [dataz[index : index + n] for index in range(0, len(dataz), n)]
...
print('Your mp3 flie has been converted to arguments.txt use the fee calc to see what it will cost to encode.')
