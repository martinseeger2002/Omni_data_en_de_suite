...
import base64
from PIL import Image #you need to insall pillow for this to work. "pip install pillows"
...
user_def_name = input('Enter prop name try "monkeytest2JPEG" "charlitopanama" "SIPI_Jelly_Beans_" "monkeinnepalJPEG" "monkeytest2JPEG" \n:')
